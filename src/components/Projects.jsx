  ...
  const projects = [
    {
      ...
      features:["A single-player game which can play on a browser (chrome)", "The player can walk around and fight enemies with their skills","The player will die if their health is zero or below."],
